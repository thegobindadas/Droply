        ...
        <div className="w-full max-w-md">
            ...
            <div className="bg-gray-900 bg-opacity-50 backdrop-blur-sm rounded-2xl border border-gray-800 p-8 shadow-2xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-white font-medium text-sm mb-6">{emailAddress}</p>
                ...
                <div className="space-y-6">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="relative group/btn w-full bg-cyan-600 hover:bg-cyan-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900 cursor-pointer"
                    >
                        {isLoading ? (
                    ...
                    <div className="text-center">
                        ...
                        {!canResend ? (
                            ...
                            <button
                                ...
                                className="text-cyan-400 hover:text-cyan-300 transition-colors duration-200 font-medium focus:outline-none focus:underline text-sm cursor-pointer"
                            >
                                Resend code
                            </button>
                        )}
